...
class LiqPay
{
	...
	public function cnb_form($params)
	{
		...
		$logo = apply_filters('woocommerce_liqpayprivat24_pay', plugins_url('assets/images/24_Pay_Black.svg',dirname(__FILE__)));
		return sprintf('<form method="POST" action="%s" accept-charset="utf-8">
                %s
                %s
                <input type="image" src="%s" name="btn_text" />
            </form>',
			$this->_checkout_url,
